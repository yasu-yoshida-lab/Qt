...
QT_MOC_LITERAL(2, 29, 0) // ""
    ...
    "SecondDialog\0okButtonClicked\0"
};
...
void SecondDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SecondDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SecondDialog::okButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SecondDialog::okButtonClicked()
{
